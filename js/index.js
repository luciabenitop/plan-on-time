...
/* ----------------------------- *\
    CARROUSEL
    Objetivo: Cuando hago click en un punto del carrousel, el carrousel se mueve a la posición del punto y se añade la clase "activo" al punto que he hecho click.

    Interacciones:
        - Hacer click en el punto del carrousel
        - Saber la posición de ese punto
        - Aplicar un transform translateX al carrousel-wrapper
...
// Selección de los elementos del carrousel
const carrousel    = document.querySelector('.Main-carrousel-wrapper')

// Selección de todos los puntos del carrousel
const puntos     = document.querySelectorAll('.Main-carrousel-punto')
...
puntos.forEach( ( cadaPunto , i )=> {
    ...
    puntos[i].addEventListener('click',()=>{
        ...
        let posicion  = i
        // Calcular el espacio que debe desplazarse el wrapper
        let operacion = posicion * -20
    
        // Mover el carrousel-wrapper
